...
class im_color
{
 public:
   ...
   float Product(im_color & in2);
   float Product(im_color & in2, int search);
   float Difference(im_color & in2);
   float Difference(im_color & in2, int search);
   ...
   void DrawLine(float M, float B, int size, short r, short g, short b);
