...
//============================================================^M
bool im_color::WriteJpg(string filename)
{
...
//============================================================^M
bool im_color::ReadJpg(string filename)
{
   char charname[STRLEN];
   strcpy(charname, filename.c_str());
...
//============================================================
void im_color::UnsharpMasking(float sigma, float weight)
{
   // Process RGB images
   R.UnsharpMasking(sigma, weight);
   G.UnsharpMasking(sigma, weight);
   B.UnsharpMasking(sigma, weight);
}
...
//============================================================
void im_color::Translate(float dx, float dy, char bound)
{
   // Process RGB images
   R.Translate(dx, dy, bound);
   G.Translate(dx, dy, bound);
   B.Translate(dx, dy, bound);
}

//============================================================
void im_color::Rotate(float angle, int cx, int cy, char bound)
{
   // Process RGB images
   R.Rotate(angle, cx, cy, bound);
   G.Rotate(angle, cx, cy, bound);
   B.Rotate(angle, cx, cy, bound);
}

//============================================================
void im_color::Scale(float sx, float sy, int cx, int cy, char bound)
{
   // Process RGB images
   R.Scale(sx, sy, cx, cy, bound);
   G.Scale(sx, sy, cx, cy, bound);
   B.Scale(sx, sy, cx, cy, bound);
}

//============================================================
void im_color::Shear(float sx, float sy, int cx, int cy, char bound)
{
   // Process RGB images
   R.Shear(sx, sy, cx, cy, bound);
   G.Shear(sx, sy, cx, cy, bound);
   B.Shear(sx, sy, cx, cy, bound);
}
...
//============================================================
void im_color::Watershed(float sigma, im_short & region)
{
   // Process RGB images
   R.Watershed(sigma, region);
   G.Watershed(sigma, region);
   B.Watershed(sigma, region);
}
...
//============================================================
float im_color::Product(im_color & in2)
{
   // Process RGB images
   float Rprod = R.Product(in2.R);
   float Gprod = G.Product(in2.G);
   float Bprod = B.Product(in2.B);
   return (Rprod + Gprod + Bprod) / 3;
}

//============================================================
float im_color::Product(im_color & in2, int search)
{
   // Process RGB images
   float Rprod = R.Product(in2.R, search);
   float Gprod = G.Product(in2.G, search);
   float Bprod = B.Product(in2.B, search);
   return (Rprod + Gprod + Bprod) / 3;
}

//============================================================
float im_color::Difference(im_color & in2)
{
   // Process RGB images
   float Rdiff = R.Difference(in2.R);
   float Gdiff = G.Difference(in2.G);
   float Bdiff = B.Difference(in2.B);
   return (Rdiff + Gdiff + Bdiff) / 3;
}

//============================================================
float im_color::Difference(im_color & in2, int search)
{
   // Process RGB images
   float Rdiff = R.Difference(in2.R, search);
   float Gdiff = G.Difference(in2.G, search);
   float Bdiff = B.Difference(in2.B, search);
   return (Rdiff + Gdiff + Bdiff) / 3;
}
...
//============================================================
void im_color::DrawLine(float Mval, float Bval, int size, 
   short r, short g, short b)
{
   // Process RGB images
   R.DrawLine(Mval, Bval, size, r);
   G.DrawLine(Mval, Bval, size, g);
   B.DrawLine(Mval, Bval, size, b);
}
